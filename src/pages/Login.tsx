...
import { Mail, Lock, LogIn, ArrowRight, Phone, KeyRound, User, Loader2 } from 'lucide-react';
...
export const Login: React.FC = () => {
  const { login, signInWithGoogle, signInWithPhone, confirmPhoneOtp, loginAsGuest } = useAuth();
